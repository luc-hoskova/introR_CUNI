...
Co kdybychom chtěli, aby se nám všechny naše skripty a jejich výsledky automatick\\ ukládaly do a tahaly rovnou z **jednoho specifického adresáře** bez potřeby ho při každém otevření RStudia nastavovat, a který bychom navíc mohli jednoduše vzít a přesunout či ho někomu zazipovaný poslat?
