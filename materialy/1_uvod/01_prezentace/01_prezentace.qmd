...
`"C:/Users/Lucie Hošková/Desktop/prace/vyzkum/zmeny_na_zubech/2026/pribice/data.csv"`

relativní cesta:

`"zmeny_na_zubech/2026/pribice/data.csv"`

Relativní cesta odkazuje na soubor uvnitř struktury, nikoliv pouze na specifické místo na počítači. Složku s RProjektem tak můžete zazipovat a poslat komu je třeba, přičemž daný člověk je schopen skript a soubory bez problému používat.

-   To by nešlo s absolutní cestou, jelikož jednak by se jeho účet jmenoval jinak a hlavně by měl data uložena někde jinde = cesta by nebyla platná a R by nebylo schopné soubory nalézt.
