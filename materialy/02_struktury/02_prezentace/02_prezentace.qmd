...
-   proč si ručně vytvářet celou novou funkci, která by nám třídila data dle námi daných kategoií, když to již někdo vytvořil jako funkci `group_by` v balíčku `dplyr`?
...
2.  výběrem skrz rozhraní
    ...
    Zkouška stažení balíčku intallr kvůli funkci updateR která updatuje na novou verzi R
