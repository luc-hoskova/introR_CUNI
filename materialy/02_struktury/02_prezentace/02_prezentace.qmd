...
```{r}
#definuj prvni argument a rovnou ho uloz jako promennou
rep(osobaID <- 5, 3)
osobaID + 4
```
...
Můžeme zapsat sekvenci od 1 do 10 s počtem hodnot 3 pomocí následujícího kódu? Pokud ne, opravte.
...
Pomocí funkce `tibble` ze stejnojmenného balíčku jsme si vytvořili tibble tabulku.
...
Nezapomeňte, StackOverflow a jiné stránky jsou vaši nejlepší kamarádi ;)
...
Skript zašlete nejpozději do pátku před příští hodinou na [lucie.hoskova\@ruk.cuni.cz](mailto:lucie.hoskova@ruk.cuni.cz)
