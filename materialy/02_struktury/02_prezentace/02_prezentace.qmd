...
1.  Vypište alespoň tři rozdílné způsoby, jak získat následující vektor: 1 2 3 1 2 3 9 8 7 2
...
> **objekt složený z vektorů stejného datového typu a délky o několika libovolném počtu dimenzí**
...
-   use case
    ...
    temps <- array(
    c(
    20,22,19,21,18,20,17,19,21,23,20,22,19,21,
...
2.  Vytvořte matici o šesti řádcích, která bude tvořena pouze dvěma alternujícími se řádky s čísly 15 - 20 a 37 - 42 (vyrobte pruhovanou matici :\] ).
...
```{r}
matrix(1:6, ncol = 3,
       dimnames = list(c("cesko", "slovensko"), c("jara", "slawa", "pepa")),
       byrow = TRUE)
```

Můžeme vytvořit jména rovnou už ve funkci matrix? Dmnames musí být list, návaznost na to co je to list
